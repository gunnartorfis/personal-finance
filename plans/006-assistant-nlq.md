...
| 2b | **Tool layer — search + status**: `searchTransactions`, `getSpendingTrend`, `getSavingsStatus`, `getFinancialHealth`; append to the `assistantTools` registry. zod in/out, tenant-scoped, no LLM. | `lib/assistant/tools/*` | PR-OPEN |
