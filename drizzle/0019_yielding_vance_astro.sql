...
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_exclusion_note_requires_excluded" CHECK ("transactions"."exclusion_note" IS NULL OR "transactions"."excluded");