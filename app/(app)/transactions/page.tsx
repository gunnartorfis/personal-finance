...
export default async function TransactionsPage({
  ...
  // The overview combines this cycle's card transactions with the configured amounts in force that
  // cycle (ADR-0015): Monthly income joins the marked card credits (ADR-0009) on the Income line,
