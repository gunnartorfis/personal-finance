...
describe("SettingsNav", () => {
  it("renders a link for every settings section", () => {
    ...
    render(<SettingsNav />)
    expect(screen.getByRole("link", { name: "Income" })).toHaveAttribute("href", "/settings/income")
    expect(screen.getByRole("link", { name: "Rules" })).toHaveAttribute("href", "/settings/rules")
